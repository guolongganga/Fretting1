...
public class BitmapUtils {
     ...
     * @return
     */
    private static String saveMyBitmap(String filename, Bitmap bit) throws Exception {
        ...
        filePath = dir + "/" + System.currentTimeMillis()+filename;
     ...
     * @return
     */
    public static String compressImageUpload(String path) throws Exception{
